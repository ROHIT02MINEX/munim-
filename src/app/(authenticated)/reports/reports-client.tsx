...
export default function ReportsPage() {
  ...
  const monthlyData = [
    ...
    { month: "Feb", income: 38000, expense: 31000 },
    { month: "Mar", income: 52000, expense: 29000 },
    { month: "Apr", income: 48000, expense: 34000 },
    { month: "May", income: 60000, expense: 38000 },
    { month: "Jun", income: totalIncome > 0 ? totalIncome : 53000, expense: totalExpense > 0 ? totalExpense : 31700 },
  ];

  const maxMonthVal = Math.max(...monthlyData.map(d => Math.max(d.income, d.expense)), 10000) * 1.1;
